    ...
    <section id="approach" className="flex scroll-mt-4 flex-col gap-4 py-6 sm:gap-5 sm:py-8 lg:py-8">
      ...
      <div className="relative flex flex-col gap-6 sm:gap-7">
        ...
        {process.map((step, index) => (
          ...
          >
            <span className="absolute left-0 top-0 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-gold/40 bg-bg text-[11px] font-medium text-gold shadow-[0_0_16px_rgba(201,161,74,0.25)] sm:h-8 sm:w-8 sm:text-xs">
              {index + 1}
            </span>
